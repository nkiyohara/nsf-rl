...
## State and Condition
- State (7D): `[pos_agent_x, pos_agent_y, block_x, block_y, sin(theta), cos(theta), phase]`
  - Pixel-like terms are normalized to [-1, 1]. Angle from degrees is converted to radians and expanded to `sin, cos`.
